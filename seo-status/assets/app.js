...
const NAV = [
  ...
  { group: 'База', items: [['notes', 'Конспекты', '✎'], ['bots', 'Боты и Make', '⚡'], ['settings', 'Данные', '⚙']] },
];
  ...
  <div class="app ${ui.selected ? 'has-detail' : ''}">
    <aside class="sidebar">
      <div class="brand">
        ...
        <div><div class="brand-name">Пульт</div><div class="brand-sub">ivanilin.ru/seo-status</div></div>
      </div>
      ${nav}
...
const ACTIONS = {
  ...
  async ping() { await sendToWebhook('ping', { from: 'seo-status', at: new Date().toISOString() }); },
  async 'create-bot'() {
